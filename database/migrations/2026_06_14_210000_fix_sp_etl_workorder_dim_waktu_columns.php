...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // SP baca staging_workorder_flat — ZERO JSON parsing
        $sql = <<<'SQL'
...
BEGIN
    ...
    SELECT
        ...
        s.tanggal, s.tanggal_order, s.tanggal_komitmen, s.tgl_input_hd_gdocs,
        ...
        s.total_eskalasi, s.jumlah_kendala, s.is_unsc
    ...
    -- FIX: dim_sto tidak punya kolom kode_sto, hanya nama_sto
